...
/// <summary>
/// Minimal <see cref="IApplicationDbContext"/> implementation for CreateItemImport
/// handler/validator tests. Maps <see cref="ItemImport"/> plus the <see cref="FileMetadata"/> and
/// <see cref="UserProfile"/> entities it references. Entities not touched by this slice are ignored
/// so EF's in-memory model stays unambiguous. Mirrors CategoryImportTestDbContext.
/// </summary>
