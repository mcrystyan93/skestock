...
/// <summary>
/// <see cref="IApplicationDbContext"/> for ConfirmItemImport tests. Maps <see cref="Item"/> and
/// <see cref="Category"/> (the write targets) and <see cref="ItemImport"/> (the source being
/// confirmed); everything else is ignored so EF's in-memory model stays unambiguous. Mirrors
/// ConfirmCategoryImportTestDbContext.
/// </summary>
public class ConfirmItemImportTestDbContext(DbContextOptions<ConfirmItemImportTestDbContext> options)
