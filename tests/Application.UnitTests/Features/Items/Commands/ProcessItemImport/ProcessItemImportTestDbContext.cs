...
/// <summary>
/// Minimal <see cref="IApplicationDbContext"/> implementation for ProcessItemImport handler tests.
/// Maps <see cref="ItemImport"/> plus the <see cref="FileMetadata"/> it references; everything else
/// is ignored so EF's in-memory model stays unambiguous. Mirrors ProcessCategoryImportTestDbContext.
/// </summary>
public class ProcessItemImportTestDbContext(DbContextOptions<ProcessItemImportTestDbContext> options)
