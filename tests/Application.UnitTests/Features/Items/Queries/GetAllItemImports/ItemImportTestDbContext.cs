...
/// <summary>
/// Minimal <see cref="IApplicationDbContext"/> implementation for GetAllItemImports
/// handler/validator tests. Maps <see cref="ItemImport"/> plus the <see cref="FileMetadata"/> and
/// <see cref="UserProfile"/> entities it references; everything else is ignored so EF's in-memory
/// model stays unambiguous. Mirrors GoodsReceiptImportTestDbContext under
/// Queries/GetAllGoodsReceiptImports.
/// </summary>
public class ItemImportTestDbContext(DbContextOptions<ItemImportTestDbContext> options)
