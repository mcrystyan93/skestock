...
/// <summary>
/// <see cref="IApplicationDbContext"/> for GetItemImportById (review) tests. Maps
/// <see cref="ItemImport"/> (the source), <see cref="Category"/> (for the "already exists" match)
/// and <see cref="Item"/> (for the SKU "already exists" match); everything else is ignored so EF's
/// in-memory model stays unambiguous. Mirrors CategoryImportReviewTestDbContext.
/// </summary>
public class ItemImportReviewTestDbContext(DbContextOptions<ItemImportReviewTestDbContext> options)
