...
/// <summary>
/// Minimal <see cref="IApplicationDbContext"/> implementation for ProcessGoodsReceiptImport
/// handler tests. Maps <see cref="GoodsReceiptImport"/> plus the <see cref="FileMetadata"/> it
/// references; everything else is ignored so EF's in-memory model stays unambiguous.
/// </summary>
public class ProcessGoodsReceiptImportTestDbContext(DbContextOptions<ProcessGoodsReceiptImportTestDbContext> options)
