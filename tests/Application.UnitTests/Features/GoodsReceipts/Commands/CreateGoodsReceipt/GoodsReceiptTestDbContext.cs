...
/// <summary>
/// Minimal <see cref="IApplicationDbContext"/> implementation for GoodsReceipt handler/validator
/// tests. Maps <see cref="GoodsReceipt"/>, <see cref="StockBatch"/>, <see cref="StockTransaction"/>
/// and the <see cref="Item"/>/<see cref="Location"/>/<see cref="SchoolClass"/>/<see cref="Category"/>
/// entities they reference, plus <see cref="UserProfile"/> for the various CreatedBy/
/// LastModifiedBy/User navigations. Mirrors CategoryTestDbContext/ItemTestDbContext and avoids
/// EF's "ambiguous one-to-one relationship" error the full production model would trigger for
/// UserProfile.
/// </summary>
public class GoodsReceiptTestDbContext(DbContextOptions<GoodsReceiptTestDbContext> options)
    : DbContext(options), IApplicationDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<ClassItemStockVisibility>(b =>
        {
