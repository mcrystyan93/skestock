...
/// <summary>
/// Minimal <see cref="IApplicationDbContext"/> implementation for ProcessCategoryImport handler
/// tests. Maps <see cref="CategoryImport"/> plus the <see cref="FileMetadata"/> it references;
/// everything else is ignored so EF's in-memory model stays unambiguous.
/// </summary>
public class ProcessCategoryImportTestDbContext(DbContextOptions<ProcessCategoryImportTestDbContext> options)
