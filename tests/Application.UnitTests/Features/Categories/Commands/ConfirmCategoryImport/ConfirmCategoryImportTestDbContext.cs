...
/// <summary>
/// <see cref="IApplicationDbContext"/> for ConfirmCategoryImport tests. Maps <see cref="Category"/>
/// (the write target) and <see cref="CategoryImport"/> (the source being confirmed); everything else
/// is ignored so EF's in-memory model stays unambiguous.
/// </summary>
public class ConfirmCategoryImportTestDbContext(DbContextOptions<ConfirmCategoryImportTestDbContext> options)
