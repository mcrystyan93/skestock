...
public sealed class CategoryImportSortConfiguration : IKeysetSortConfiguration<CategoryImport>
{
    ...
    public Expression<Func<CategoryImport, dynamic>> GetPropertyExpression(string propertyName)
    {
    ...
    public object? GetPropertyValue(CategoryImport entity, string propertyName)
    {
        return propertyName switch
        {
